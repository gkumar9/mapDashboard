    ...
    if(this.props.location.state!==undefined){
      await axios({
        ...
        .then(res => {
          ...
          singleassetstatttemp.totalCo2Emission=parseInt(singleassetstatttemp.totalCo2Emission).toLocaleString("en-IN")
          singleassetstatttemp.totalDischarge=parseInt(singleassetstatttemp.totalDischarge).toLocaleString("en-IN")
          singleassetstatttemp.totalEnergy=parseInt(singleassetstatttemp.totalEnergy).toLocaleString("en-IN")
