    ...
    if (this.props.location.state !== undefined) {
      ...
      await axios({
        ...
        .then(res => {
          ...
          document
            .getElementById("drillUp")
            .addEventListener("click", function() {
              document.getElementById("energy_chart").style.display = "block";
              document.getElementById("drilldownContainer").style.display =
                "none";
          ...
          function createDrillDownCharts(activity) {
            ...
            activity.datasets.forEach(function(dataset, i) {
              ...
              document
                .getElementById("drilldownContainer")
                      ...
                      if (this.options != null) {
                        ...
                        axios({
                          ...
                          data: {
                            ...
                            date: dayOfYear,
                            powerType:
                              self.props.location.state.detail.powerType
                          },
                          headers: {
                            "Content-Type": "application/json"
                          }
