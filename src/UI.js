...
class Main extends Component{
	constructor(props){
		super(props)
		this.state={states:[],allpins:[],filteredstate:'',filteredpins:[],filter:{IRRIGATION_PUMP:true,PATVAN:true,DRINKING_WATER_PUMP:true,MINIGRID:true,ROOFTOP:true}}
	...
	componentDidMount(){
		...
		.then((res)=>{
			...
			if(res.data.data!==null){
				...
				this.setState({allpins:res.data.data.list,filteredpins:res.data.data.list,states:tempstate})
			}
		...
		return(		 
				<div> 	
			  	...
			  	<div className="mainbody">
				  	<Sidebar />
				  	<div className="main">
				  		<Filter states={this.state.states} selectedstate={this.state.filteredstate} onChangeStates={this.handlestatefilter} filter={this.state.filter} onChangeFilter={this.handleFilterChange} onFilterReset={this.handleReset} onFilterApply={this.handleApply}/>
